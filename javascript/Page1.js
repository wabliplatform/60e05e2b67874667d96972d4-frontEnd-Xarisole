let apiProjectApi = new TempApi.ProjectApi();import TempApi from '../src/index';let project = new TempApi.Project();document.getElementById('iqavd').onclick = (event) => {
...
document.getElementById('ihhls').onclick = (event) => {
    event.preventDefault();
